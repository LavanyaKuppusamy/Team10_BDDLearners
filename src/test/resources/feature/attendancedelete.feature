...
Feature: Delete Attendance
 ...
 Background:
   ...
   When Admin clicks "Attendance" from navigation bar
 ...
 @user_23
  ...
  Scenario: Validate the delete icon below the header 
   ...
   Then The delete icon under the "Manage Attendance" header should be disabled
   
   @user_27
 	 Scenario: Check for single row delete
    Given One of the checkbox row is selected
    When Click delete icon below "Manage Attendance" header
