...
public class UserManagePage_SD extends Constant {
	...
	public void the_pop_up_should_include_the_fields_from_and(String SheetName, String Testcase) throws IOException {
	...
	public void the_new_pop_up_with_user_details_appears() {
	...
	public void fill_in_all_the_fields_except_optional_fields_with_valid_values_from_and(String SheetName,
	...
	public void fill_in_all_the_fields_with_valid_values_from_and(String SheetName, String Testcase)
			throws IOException {
	...
	public void any_of_the_fields_have_invalid_values_from_and(String SheetName, String Testcase) throws IOException {
		setUserDetails(SheetName, Testcase);
	...
	public void any_of_the_mandatory_fields_are_blank_from_and(String SheetName, String Testcase) throws IOException {
		setUserDetails(SheetName, Testcase);
	}
	...
	public void pdate_the_fields_with_valid_values_from_and(String SheetName, String Testcase) throws IOException {
		setUserDetails(SheetName, Testcase);
	}
	...
	public void update_the_fields_with_invalid_values_from_and(String SheetName, String Testcase) throws IOException {
		setUserDetails(SheetName, Testcase);
	}
	
	// @user_21 Edit user
	@When("Erase data from mandatory field from {string} and {string}")
	public void erase_data_from_mandatory_field_from_and(String SheetName, String Testcase) throws IOException {
		setUserDetails(SheetName, Testcase);
	...
	public void erase_data_from_description_field_from_and(String SheetName, String Testcase) throws IOException {
		setUserDetails(SheetName, Testcase);
